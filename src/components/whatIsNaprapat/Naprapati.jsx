    ...
    >
      ...
      <div className="lg:w-1/2 w-full  flex flex-col px-4 lg:px-0 bg-main-100">
        <div className="m-12 ">
          ...
          <p className="mt-3 text-justify flex-grow text-dark-text">
          ...
          <button 
            className="flex justify-center items-center gap-4 bg-main-500 hover:bg-main-400 w-full max-w-[320px] sm:max-w-[188px] h-[56px] mx-auto mt-6 mb-[40px] rounded-[8px] text-white text-lg cursor-pointer"
          >
